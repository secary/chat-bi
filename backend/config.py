...
class Settings:
    ...
    app_db_port: str = field(
        default_factory=lambda: os.getenv("CHATBI_APP_DB_PORT", os.getenv("CHATBI_DB_PORT", "3307"))
    )
    ...
    admin_db_password: str = field(
        default_factory=lambda: os.getenv(
            ...
            os.getenv("CHATBI_APP_DB_PASSWORD", os.getenv("CHATBI_DB_PASSWORD", "demo_pass")),
        )
    )
