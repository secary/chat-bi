...
| 轮次 | 完成内容                                                                                                                                                 | 验证                                                                                                                                                                                      |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 213  | 将浏览器 tab favicon 从旧紫色闪电切换为零眸 SVG 眼睛图标，并同步覆盖兼容路径 `/favicon.svg`，避免旧入口或 Safari 缓存继续显示闪电                         | `PYTHONPATH=. .venv/bin/python scripts/format_code.py frontend/index.html`；`cd frontend && npm run lint`；`cd frontend && npm run build`                                                |
