...
ChartRecommendationRequest = _CORE.ChartRecommendationRequest
run_chart_recommendation = _CORE.run_chart_recommendation


def parse_request_args(argv: Optional[Sequence[str]] = None) -> ChartRecommendationRequest:
    ...
    return ChartRecommendationRequest(raw_input=raw_input)


def run(argv: Optional[Sequence[str]] = None, context: Any = None) -> dict[str, Any]:
    return run_chart_recommendation(parse_request_args(argv), context)
